...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Recruiter Team Member'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Supervisor', 'Recruiter Team Member'];
  const addOns: string[] = ['file', 'notifications'];
  const applicationName = `RecruiterProductivity`;
  const tenantName = `Recruiter`;
