...
import { getPipelineCandidateById } from 'apiSdk/pipeline-candidates';
...
function PipelineCandidateViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Pipeline Candidate Detail View
          </Text>
          {hasAccess('pipeline_candidate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/pipeline-candidates/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              {hasAccess('pipeline', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/pipelines/view/${data?.pipeline?.id}`}>
                      {data?.pipeline?.name}
                    </Link>
                  </Text>
                </Flex>
